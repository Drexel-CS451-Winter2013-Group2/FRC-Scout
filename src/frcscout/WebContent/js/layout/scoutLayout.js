function getMatchRecordStore() {
        store1 = Ext.create('Ext.data.JsonStore', {
            fields: ['id', 'user', 'team_id', 'match_id', 'event_id', 'event_name', 'color', 'auton_top',
	...
	return [{
        ...
        items: [{
            ...
            columns: [
                ...
                { header: 'Play Style', dataIndex: 'play_style', hidden: true},
                { header: 'Confidence', dataIndex: 'confidence', hidden: true},
                { header: 'Ability', dataIndex: 'ability', hidden: true},
                { header: 'Fouls', dataIndex: 'fouls', hidden: true},
                { header: 'Techincal Fouls', dataIndex: 'technical_fouls', hidden: true},
